  ...
  return (
    <section className="w-full">
      <div className="relative">
        ...
        />
        <div className="relative">
          <div className="absolute w-20 h-20 left-6 -bottom-[2.5rem] border-[0.25rem] border-[#2B2B2B] rounded-full z-[15] bg-darkish-60 flex flex-col justify-center items-center ">
