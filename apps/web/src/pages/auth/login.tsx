  ...
  return (
    <>
      <div className="bg-auth w-full h-svh flex flex-col justify-around items-center px-[2.5rem]">
        ...
        <div className="w-full mx-auto md:mt-0 md:w-[25.5rem] md:h-[35rem] md:p-[2.5rem] md:bg-whitish-5 md:rounded-[2rem] md:shadow-card md:backdrop-blur-[3.125rem]">
          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="flex flex-col gap-3">
              <Button
                ...
                child={<Typography level="base-sb">Sign In</Typography>}
              ...
              >
                ...
                <a href="/register" className="opacity-100 font-semibold">
                  <Typography level="caption-sb" className="opacity-100">
                    Sign up, it's free!
                  </Typography>
                </a>
              </Typography>
