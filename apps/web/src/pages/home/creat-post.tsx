  ...
  return (
    <div className="fixed w-full h-full top-0 left-0 bg-[#444444] z-20 md:bg-[#12121299] shadow-stack">
      <div className="hidden md:block absolute top-2 right-2 z-20">
        <Button className="size-[40px] p-2.5" child={<X />} onClick={onBack} />
      </div>
      <div className="w-full h-full bg-grayish-70 md:mx-auto md:w-[40rem] md:h-[16rem] md:mt-[10%] md:rounded-button md:backdrop-blur-[32px]">
        <div className="md:hidden w-full flex items-center justify-between p-3">
          ...
          <CircleButton
            ...
            children={<Typography level="base-sb">Post</Typography>}
          />
        </div>
        ...
        <div className="w-full max-h-screen mx-auto flex justify-center items-center md:h-full md:flex-col md:items-start md:justify-between md:static md:rounded-[2rem] ">
          ...
          <div className="fixed bottom-4 w-fit mx-auto rounded-[1.25rem] p-2 flex gap-2 items-center bg-reddish-3 z-20 md:w-full md:bg-transparent md:relative md:mx-0 md:justify-between md:bottom-0">
            <EmojiButton />
            <ImageButton />
            <GifButton />
            <TagButton />
            ...
            <Button
              ...
              child={<Typography level="base-sb">Post</Typography>}
            ></Button>
          </div>
        </div>
      </div>
