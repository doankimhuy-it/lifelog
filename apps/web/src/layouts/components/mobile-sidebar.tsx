...
import { Note, SignOut, Sliders, X } from '@phosphor-icons/react';
  ...
  return (
    ...
    >
      ...
      >
          ...
          <div className="flex flex-1 items-center bg-red-100">
            ...
            <span className="p-1 inline-flex gap-1 z-9">
              <NavLink to="/settings?view=account-settings" className={'p-2.5'}>
                <Sliders className="h-6 w-6 stroke-secondary hover:stroke-primary" />
              </NavLink>
              <NavLink to="/login" className={'p-2.5'}>
                <SignOut className="h-6 w-6 stroke-secondary hover:stroke-primary" />
              </NavLink>
            </span>
          </div>
        </div>
        ...
        >
          <Typography level="base-sb" className="text-secondary select-none">
            Post
          </Typography>
        </CircleButton>
      </div>
