...
export default function ComposerInput({ usedBy }: PostContentProps) {
  ...
  return (
    <div
      className={`w-full flex ${isInputFocused ? 'flex-col bg-grayish-70' : 'flex-row bg-reddish-2'} gap-3 items-center justify-between p-3 bottom-0  rounded-[1.25rem]`}
    >
      <div
        id="reply-content"
      ...
      >
        ...
        <Button
          ...
          type="submit"
          child={
            <Typography className="text-secondary" level="base-sb">
