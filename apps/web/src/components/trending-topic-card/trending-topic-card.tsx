...
export default function TrendingTopicCard({
  ...
  return (
    <div
      className={cn(
        'relative bg-reddish-2 rounded-[1.25rem] p-3 flex items-center gap-4 hover:bg-reddish-5 focus:border-[3px] focus:border-reddish-10',
        className,
      )}
    >
      <svg
      ...
      <div className="flex flex-col gap-3">
        <Typography level="base-sb" className=" text-primary opacity-80">
          {trendingName}
        </Typography>
        <div className="flex items-center justify-start gap-3">
          ...
          <Typography level="caption" className="opacity-45 text-tertiary">
            {time} hours ago
          </Typography>
        </div>
      </div>
